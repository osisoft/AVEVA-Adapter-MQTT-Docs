...
| **DefaultStreamIdPattern**    | Optional         | `string`  |  Specifies the default stream Id pattern to use. Possible parameters: `{BaseTopic}`, `{Topic}`, `{MetricName}`. <br><br>Allowed value: any string<br>Default value: `{BaseTopic}.{MetricName}`
